...
class BorjanSpider(scrapy.Spider):
   ...
   # allowed_domains = ['https://www.borjan.com.pk/collections/sale-men']
    start_urls = [

        'https://www.borjan.com.pk/collections/sale-women',
         'https://www.borjan.com.pk/collections/sale-men'
    #    'file:///E:/Semester%207/pages%20html/borjan.html'      
     ]    
...
#
    ...
    def parse(self, response):
        ...
        for quotes in all_div_quotes:
            ...
            # gender_category=quotes.css('span span.active-bread::text').get()
            gender_category=quotes.xpath('//*[contains(concat( " ", @class, " " ), concat( " ", "active-bread", " " ))]/text()').get()
           # gender_category=quotes.css('h1::text').get().replace('\r\n','').strip()
            ...
            if (BorjanSpider.isWordPresent(gender_category, 'men')):
                gender_category='male'
                category_name='shoes' 
                category_id=11
                gender_id=2

            elif (BorjanSpider.isWordPresent(gender_category, 'women')):
                gender_category='female'
                category_name='shoes' 
                category_id=11
                gender_id=1

            elif (BorjanSpider.isWordPresent(gender_category, 'kids')):
                gender_category='kid'
                category_name='shoes' 
                category_id=11
                gender_id=3
            ...
            product_link='https://www.borjan.com.pk'+product_link  
            ...
            image_link2=quotes.css('.product-grid-image::attr(src)').get()
            if image_link2==None:
                image_link2=image_link
            
            items['brand_name'] ='Borjan'
            items['title']=title
